...
//This is a singleton design pattern. This class will ensure that only single instance should be created and single object can be used by all other classes.
